...
import MousePosition from './MousePosition.tsx'

type SpotlightProps = {
  children: React.ReactNode
  className?: string
  [key: string]: any // Permitir cualquier otro prop adicional
}

export default function Spotlight({
  children,
  className = '',
  ...props // Capturar cualquier otro prop adicional
}: SpotlightProps) {
  ...
  return (
    <div className={className} ref={containerRef} {...props}>{children}</div>
  )
}
